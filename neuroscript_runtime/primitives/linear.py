"""
Linear (dense/fully-connected) layer primitive.

Maps to NeuroScript neuron:
    neuron Linear(in_features: int, out_features: int):
        in: [*, in_features]
        out: [*, out_features]

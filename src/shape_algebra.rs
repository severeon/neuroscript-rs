...
mod tests {
    ...
    fn test_axiswise_ops() {
        ...
        assert_eq!(a.axiswise_gcd(&b), Some(Shape::new(vec![2, 3])));
    }

    #[test]
    fn test_refine_coarsen() {

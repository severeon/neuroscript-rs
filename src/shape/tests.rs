...
fn test_axiswise_gcd_basic() {
    ...
    assert_eq!(
        a.axiswise_gcd(&b),
        Some(Shape::new(vec![Dim::Literal(4), Dim::Literal(6)]))
    );
}
...
fn test_axiswise_gcd_coprime() {
    ...
    assert_eq!(
        a.axiswise_gcd(&b),
        Some(Shape::new(vec![Dim::Literal(1), Dim::Literal(1)]))
    );
}
...
fn test_axiswise_lcm_basic() {
    ...
    assert_eq!(
        a.axiswise_lcm(&b),
        Some(Shape::new(vec![Dim::Literal(12), Dim::Literal(18)]))
    );
}
...
fn test_axiswise_lcm_same() {
    ...
    assert_eq!(
        a.axiswise_lcm(&b),
        Some(Shape::new(vec![Dim::Literal(5), Dim::Literal(7)]))
    );
}
...
fn test_broadcastable_basic() {
    assert!(broadcastable(
        &Shape::new(vec![Dim::Literal(4), Dim::Literal(1), Dim::Literal(8)]),
        &Shape::new(vec![Dim::Literal(4), Dim::Literal(10), Dim::Literal(8)])
    ));
    assert!(!broadcastable(
        &Shape::new(vec![Dim::Literal(4), Dim::Literal(3), Dim::Literal(1)]),
        &Shape::new(vec![Dim::Literal(4), Dim::Literal(10), Dim::Literal(8)])
    ));
}
...
fn test_broadcastable_different_ranks() {
    assert!(broadcastable(
        &Shape::new(vec![Dim::Literal(5), Dim::Literal(6)]),
        &Shape::new(vec![Dim::Literal(6)])
    ));
    assert!(broadcastable(
        &Shape::new(vec![Dim::Literal(1)]),
        &Shape::new(vec![
            Dim::Literal(8),
            Dim::Literal(1),
            Dim::Literal(6),
...
fn test_broadcastable_all_ones() {
    assert!(broadcastable(
        &Shape::new(vec![Dim::Literal(1), Dim::Literal(1), Dim::Literal(1)]),
        &Shape::new(vec![Dim::Literal(8), Dim::Literal(4), Dim::Literal(6)])
    ));
}
...
fn test_broadcastable_incompatible() {
    assert!(!broadcastable(
        &Shape::new(vec![Dim::Literal(3), Dim::Literal(4)]),
        &Shape::new(vec![Dim::Literal(2), Dim::Literal(5)])
    ));
}
...
fn test_refine_axis_three_factors() {
    ...
    assert_eq!(
        r,
        Shape::new(vec![Dim::Literal(2), Dim::Literal(3), Dim::Literal(4)])
    );
}
...
fn test_coarsen_axes_middle() {
    ...
    assert_eq!(
        c,
        Shape::new(vec![Dim::Literal(2), Dim::Literal(12), Dim::Literal(5)])
    );
}
...
fn test_embedding_pattern() {
    ...
    let captured = pat
        .matches_and_capture(
            &Shape::new(vec![Dim::Literal(30000), Dim::Literal(512)]),
            true,
        )
        .unwrap();
